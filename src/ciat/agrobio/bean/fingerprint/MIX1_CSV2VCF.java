/*
 *
 * BioInfoJava-Utils ciat.agrobio.bean.fingerprint.MIX1_CSV2VCF
 *
...
public class MIX1_CSV2VCF {

	public static void main(String[] args) {
		try {
			//Load markers data from first input csv file
			//NCBI_AssayID,RefAlt,Pos,Chr
			...
			for(int i=0; i<markers_data.size(); i++) {
				...
				String refbase = refalt1;
				String altbase = refalt2;
