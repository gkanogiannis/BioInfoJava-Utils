/*
 *
 * BioInfoJava-Utils ciat.agrobio.javautils.UtilVCFKeepSamples
 *
...
@Parameters(commandDescription = "VCFKeepSamples")
public class UtilVCFKeepSamples {

	private static UtilVCFKeepSamples instance = new UtilVCFKeepSamples();

	private UtilVCFKeepSamples() {
	}

	public static UtilVCFKeepSamples getInstance() {
		return instance;
	}

	public static String getUtilName() {
		return "VCFKeepSamples";
	}
