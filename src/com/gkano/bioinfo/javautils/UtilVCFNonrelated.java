/*
 *
 * BioInfoJava-Utils ciat.agrobio.javautils.UtilVCFNonrelated
 *
...
@Parameters(commandDescription = "VCFNonrelated")
public class UtilVCFNonrelated {

	private static UtilVCFNonrelated instance = new UtilVCFNonrelated();

	private UtilVCFNonrelated() {
	}

	public static UtilVCFNonrelated getInstance() {
		return instance;
	}

	public static String getUtilName() {
		return "VCFNonrelated";
	}
