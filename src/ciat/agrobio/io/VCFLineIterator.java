...
public class VCFLineIterator<T> implements Iterator<T>, Iterable<T> {
    ...
    public VCFLineIterator(VCFDecoderInterface<T> decoder, List<String> inputPaths) {
    ...
    public VCFLineIterator(VCFDecoderInterface<T> decoder, String... inputPaths) {
